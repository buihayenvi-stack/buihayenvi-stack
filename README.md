...
### 🚀 About Me
- Actively learning **Node.js for Backend development**
...
- C#, .NET, WinForms  
- Python (AI/ML, OpenCV, NumPy, TensorFlow/PyTorch) 
- Java, C/C++  
- JavaScript, HTML/CSS (Including Node.js/Backend - Learning)

#### **Tools & Platforms**
- NetBeans, VMware Workstation
...
- Writing maintainable, optimized
